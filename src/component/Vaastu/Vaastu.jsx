...
const Vaastu = () => {
  ...
  const handleSubmit = () => {
    const url = "https://spandan-git-main-ketankapale8.vercel.app/api/v1/addvaastu"
  ...
  const handleFileUpload5 = async (e) => {
    ...
    const base64 = await convertToBase64(file);
    console.log(base64)
    setFormData({...formData , option5Input : base64 })
  }
  ...
  const handleFileUpload6 = async (e) => {
    ...
    const base64 = await convertToBase64(file);
    console.log(base64)
    setFormData({...formData , option6Input : base64 })
  }
  ...
  const handleFileUpload7 = async (e) => {
    ...
    const base64 = await convertToBase64(file);
    console.log(base64)
    setFormData({...formData , option7Input : base64 })
  }
  ...
  const handleFileUpload8 = async (e) => {
    ...
    const base64 = await convertToBase64(file);
    console.log(base64)
    setFormData({...formData , option8Input : base64 })
  }
